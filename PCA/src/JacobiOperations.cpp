...
void applyOnTheLeft_par(Mat &matrix, size_t p, size_t q, double c, double s) {
...
void applyOnTheRight_par(Mat &matrix, size_t p, size_t q, double c, double s) {
    #pragma omp parallel for
...
void real_2x2_jacobi_svd_par(Mat &matrix, double &c_left,double &s_left,double &c_right,double &s_right,size_t  p, size_t  q) {
