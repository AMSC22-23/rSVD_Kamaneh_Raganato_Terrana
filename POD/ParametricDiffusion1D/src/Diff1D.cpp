...
main(int argc, char * argv[])
{
  ...
  // Mat_m approximations = Mat_m::Zero(snapshot_length, rom_sizes.size()); // lo avevi tolto per più parametri con una sola rom size ma non ha senso);
  // avrebbe doppio indice
